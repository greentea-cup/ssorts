#include "util.hpp"
#include "ssorts/insertion_sort.hpp"

TEST(TestInsertionSort, TestOne_Sorted) {
	int data[1] {10};
	insertion_sort(data, 1);
	ASSERT_EQ(data[0], 10);
}

TEST(TestInsertionSort, Test10_Sorted) {
...
TEST(TestInsertionSort, Test100Random_Sorted) {
...
TEST(TestInsertionSort, Test1000Random_Sorted) {
